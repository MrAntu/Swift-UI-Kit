...
## 0.9.1
DDDebug 更新 Hook Framework，避免出现崩溃情况
...
## 0.9.3
1、DDDebug hook完善回调
2、DDDebug 设置是否hook开关，避免污染线上代码
3、DDDebug log 增加白名单功能，定制需要显示的网络请求 

## 0.9.4
CustomCamera修复裁剪后图片旋转90度问题

## 0.9.5
Core扩展view加载nib，cell注册nib，方便快捷
...
## 0.9.9
PhotoBrowser优化dissmiss动画

## 1.0.0
解决PhotoBrowser和VideoPlayer定义冲突

## 1.0.1
PhotoBrowser添加视频播放属性

## 1.0.2
1.Chainable新增属性，以及修改UITableView代理回调冲突
2.将部分core中功能移入到Chainable中

## 1.0.3
再次优化PhotoBrowserd dissmiss动画，更顺畅
