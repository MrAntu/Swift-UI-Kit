...
public class DDScanWrapper: NSObject {
    ...
    static public func createQrCode(codeString: String, size: CGSize, qrColor: UIColor, backgroudColor: UIColor ) -> UIImage? {
        ...
        //上色
        let colorFilter = CIFilter(name: "CIFalseColor", parameters: ["inputImage": outputImage, "inputColor0": CIColor(cgColor: qrColor.cgColor), "inputColor1": CIColor(cgColor: backgroudColor.cgColor)])
